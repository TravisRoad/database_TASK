...
为避免幻读，需要采用 Serializable 隔离级别 ，读用读锁，写用写锁，读锁和写锁互斥，可以有效避
...
![image-20201215224850442](实验报告.assets/image-20201215224850442.png)
...
![image-20201215222011995](实验报告.assets/image-20201215222011995.png)
